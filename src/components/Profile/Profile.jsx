...
function Profile({ avatar, name, tag, location, stats }) {
  return (
    <div className={css.profile}>
      <img src={avatar} alt={name} className={css.profileImg} />

      <div className={css.profileInformation}>
        <h1 className={css.profileh1}>{name}</h1>
        <h3 className={css.bottomh2}>@{tag}</h3>
        <h3 className={css.bottomh2}>{location}</h3>
      </div>
